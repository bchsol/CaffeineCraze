...
import "@klaytn/contracts/contracts/utils/Context.sol";
import "@klaytn/contracts/contracts/KIP/utils/introspection/KIP13.sol";
import "@klaytn/contracts/contracts/KIP/token/KIP17/extensions/IKIP17Metadata.sol";
import "@klaytn/contracts/contracts/utils/Address.sol";
import "@klaytn/contracts/contracts/utils/Strings.sol";
import "@klaytn/contracts/contracts/KIP/token/KIP17/IKIP17Receiver.sol";
import "@klaytn/contracts/contracts/token/ERC721/IERC721Receiver.sol";
 ...
 * {KIP17Enumerable}.
 */
contract KIP17r is Context, KIP13, IKIP17, IKIP17Metadata {
    ...
    function tokenOfOwnerByIndex(address owner, uint256 index) public view virtual returns (uint256) {
        require(index < balanceOf(owner), "KIP17: owner index out of bounds");
    ...
    function _mintIdWithoutBalanceUpdate(address to, uint256 tokenId) private {
        ...
        _ownedTokens[to].push(tokenId); // Add the token ID to the owner's list of owned tokens
    ...
    function _mintRandom(address to, uint _numToMint) internal virtual {
        ...
        require(_numToMint > 0, "KIP17r: need to mint at least one token");
        
        // TODO: Probably don't need this as it will underflow and revert automatically in this case
        require(_numAvailableTokens >= _numToMint, "KIP17r: minting more tokens than available");
    ...
    function _mintAtIndex(address to, uint index) internal virtual {
        require(_msgSender() == tx.origin, "Contracts cannot mint");
        require(to != address(0), "KIP17: mint to the zero address");
        require(_numAvailableTokens >= 1, "KIP17r: minting more tokens than available");
    ...
    function _transfer(
        ...
        // Remove the token ID from the sender's list of owned tokens
